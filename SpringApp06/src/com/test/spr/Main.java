...
public class Main
{
	public static void main(String[] args)
	{
		...
		*/
		...
		// cal : 찬우 객체 
		// cal.getClass() : 찬우 객체의 설계도 
		// cal.getClass().getClassLoader() : 찬우 객체의 설계도의 정보를 얻어오는 과정
		// cal.getClass().getInterfaces()  : 찬우 객체를 만들어내는 설계도의 인터페이스
		// new CalculatorProxy(cal) : 태민이 객체 생성해서 찬우 객체 넘겨줌
